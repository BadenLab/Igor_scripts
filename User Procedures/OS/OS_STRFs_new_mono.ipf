...
function OS_STRFs_new_mono()

	wave triggertimes 
	variable nColours = 1 //force monochromatic
	variable nTriggers_per_Colour = numpnts(triggertimes) // hack
...
//////// NEW VARIABLEWS NOT IMPLEMENTED FULLY YET
	...
	variable CropNoiseEdges =3 //20 for 25um(=1.18deg) // HACK FOR NOW
...
if (Display_Stuff==1)
	...
	newimage strf_corr_montage_rgb
	newimage strf_corr_montage_rgb2
